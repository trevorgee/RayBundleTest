...
/**
 * Entry point to the refinement logic
 * @param fcn The callback function point for getting errors
 * @param m The amount of data that we have
 * @param n The amount of parameters that we have
 * @param x The collection of parameter values
 * @param msk The ability to switch on and off parameters
 * @param fvec The feature vector
 * @param total error
 * @param info information
 * @param nfev The number of values that have evaluated
 * @return The final score
 */
int Optimiser::Refine(void fcn(int, int, double*, double*, int*, void* callback), int m, int n, double x[], int msk[], double fvec[], double tol, int *info, int *nfev)
{
	int j, maxfev, mode;
	int *ipvt;
 ...
 * Normalization
 */
double Optimiser::enorm(int n, double x[])
{
	int i;
	double sum;
...
/**
 * Normalize an actual row
 */
double Optimiser::rownorm(int m, int r, int c, double **x)
{
	int i;
	double sum;
	sum = x[r][c] * x[r][c];
 ...
 * Normalize a column
 */
double Optimiser::colnorm(int m, int r, int c, double **x)
{
	int i;
	double sum;
	sum = x[r][c] * x[r][c];
 ...
 * Update Parameters
 */
void Optimiser::fdjac2(void f(int, int, double *, double *, int *, void* callback), int m, int n, double x[], double fvec[], double **fjac, int *iflag, double epsfcn, double wa[])
{
	int i, j;
 ...
 * Limit Parameters
 */
void Optimiser::lmpar(int n, double **r, int ipvt[], double diag[], double qtb[], double delta, double *par, double x[], double sdiag[], double wa1[], double wa2[])
{
 ...
 */
void Optimiser::qrfac(int m, int n, double **a, int pivot, int ipvt[], double rdiag[], double acnorm[], double wa[])
{
...
/**
 * Levenberg-Marquardt Difference
 */
void Optimiser::lmdif(void f(int, int, double*, double*, int*, void* callback), int m, int n, double x[], int msk[], double fvec[], double ftol, double xtol, double gtol, int maxfev, double epsfcn, double diag[], int mode, double factor, int *info, int *nfev, double **fjac, int ipvt[], double qtf[], double wa1[], double wa2[], double wa3[], double wa4[])
{
 ...
 */
void Optimiser::qrsolv(int n, double **r, int ipvt[], double diag[], double qtb[], double x[], double sdiag[], double wa[])
{
